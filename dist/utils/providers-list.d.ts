...
export declare const PROVIDERS_LIST: {
    ANIME: (import("../providers/anime/gogoanime").default | import("../providers/anime/9anime").default | import("../providers/anime/animepahe").default | import("../providers/anime/anify").default | import("../providers/anime/crunchyroll").default | import("../providers/anime/bilibili").default | import("../providers/anime/zoro").default | import("../providers/anime/animefox").default | import("../providers/anime/marin").default | import("../providers/anime/animekai").default)[];
    MANGA: (import("../providers/manga/mangasee123").default | import("../providers/manga/mangadex").default | import("../providers/manga/comick").default | import("../providers/manga/mangahere").default | import("../providers/manga/mangakakalot").default | import("../providers/manga/mangapark").default | import("../providers/manga/mangapill").default | import("../providers/manga/mangareader").default | import("../providers/manga/flamescans").default | import("../providers/manga/mangahost").default | import("../providers/manga/brmangas").default)[];
